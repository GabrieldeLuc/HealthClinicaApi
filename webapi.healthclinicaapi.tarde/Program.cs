...
.AddJwtBearer("JwtBearer", options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidIssuer = "webapi.healthclinica.tarde",

        //nome do audience (para onde está indo)
        ValidAudience = "webapi.healthclinica.tarde"
    };
});
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Version = "v1",
        Title = "API Health Clinica",
        Description = "API Health Clinica - Backend API",
        Contact = new OpenApiContact
        {
            Name = "Senai Informática - tarde",
            Url = new Uri("https://github.com/GabrieldeLuc")
        }
    });
